...
tqTitulo.Text = "🛡️ HMZH HUB - SISTEMAS"
...
tqInfo.Text = "📱 Toque com 3 dedos para ocultar a UI\n💻 Tecla F6 no PC para ativar o Modo Stream"
...
l2.Text = "👤 Criado: Yuri"; l2.TextColor3 = Color3.fromRGB(255, 255, 255); l2.Font = Enum.Font.Gotham; l2.TextSize = 15; l2.TextXAlignment = Enum.TextXAlignment.Left
